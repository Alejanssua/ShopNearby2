...
namespace WebApiEscolastico.Controllers
{
    ...
    {
        public IHttpActionResult Post(Vinculacion materia)
        {
            try
            {
                VinculacionBLL.Create(materia);
        ...
        public IHttpActionResult Put(Vinculacion materia)
        {
            try
            {
                VinculacionBLL.Update(materia);
